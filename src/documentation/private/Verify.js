            ...
            <div className='w-1/2 flex flex-col justify-center items-stretch'>
                {
                    1>0?<div className='h-96'>
                        <img  src={certificate} alt="Certificate" className='h-72'/>
                ...
                <div>
                    {
                        certificate?.length > 0 ? <div className='w-full flex flex-col justify-center items-center'><p className='py-5 text-green-500 text-center w-full'>Upload Completed</p></div> 
                        :  
                        <form 
